...
'''
#Based off vyshakbellur's simulation https://github.com/vyshakbellur/Virtual-Memory-Simulation-Tool/blob/master/memory.py
    ...
    def getLeastFrequent():
        ...
        for m in mainMemory.memory:
            if m.arrival < lf.arrival:
                lf = m
            if m.repeat == 0 and (m.intent == "R\n" or m.intent == "R"): #MIGHT NEED TO CHANGE THIS NOT SURE JUST A GUESS
